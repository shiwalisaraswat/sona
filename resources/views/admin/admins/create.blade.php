    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="{{ route('admin.admins.store') }}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="role" id="role">
                            @php $options = \App\Helpers\CommonHelper::getAdminRoleOption(); @endphp
                            @foreach($options as $key => $value)
                                <option value="{{ $key }}" {{ old('role', $record->role) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
